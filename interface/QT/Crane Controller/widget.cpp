...
//        serialPort.clear();
    ...
    ui->setupUi(this);
    ui->heightSlider->setMinimum(-40);
    ui->heightSlider->setMaximum(40);
    ui->heightSlider->setSingleStep(20);

    ui->angleDial->setMinimum(-36);
    ui->angleDial->setMaximum(36);
    ui->angleDial->setSingleStep(18);
